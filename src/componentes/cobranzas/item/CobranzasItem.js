...
function CobranzasItem({item}){
    ...
    return (
        <div>
            ...
            <a href="#" onClick={toggleModal}  data-target={"modal"+item.id} className="truncate hoverable white-text modal-trigger">{item.cto} - {"$ " + item.impComprobante} - {item.cv} - {item.datosCpte}</a>
